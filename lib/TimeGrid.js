...
var TimeGrid = function (_Component) {
  ...
  TimeGrid.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      this.renderHeader(range, allDayEvents, width, resources, dayOffs, groups),
  ...
  TimeGrid.prototype.renderEvents = function renderEvents(range, events, today, resources, dayOffs) {
    ...
    return rangeGroups.map(function (_ref, idx) {
      ...
      var daysEvents = events.filter(function (event) {
        return _dates2.default.inRange(date, (0, _accessors.accessor)(event, startAccessor), (0, _accessors.accessor)(event, endAccessor), 'day') && group === event.group;
      });
  ...
  TimeGrid.prototype.renderHeader = function renderHeader(range, events, width, resources, dayOffs, groups) {
    var _this4 = this;
  ...
  TimeGrid.prototype.renderHeaderGroups = function renderHeaderGroups(range, groups) {
    var _this5 = this;

    var dayPropGetter = this.props.dayPropGetter;
