...
var Custom = function (_React$Component) {
  ...
  Custom.prototype.render = function render() {
    var _props = this.props,
        date = _props.date,
        props = _objectWithoutProperties(_props, ['date']);

    var range = Custom.range(date, this.props);
...
Custom.defaultProps = _extends({}, _TimeGrid2.default.defaultProps, {
  dateRange: 7,
  dayOffs: [6, 7],
  workingHourRange: {
    from: 9,
...
Custom.navigate = function (date, action) {
  switch (action) {
...
Custom.range = function (date, _ref) {
  var culture = _ref.culture,
      visibleDates = _ref.visibleDates;

  return visibleDates.map(function (d) {
    return (0, _moment2.default)(d).startOf('day').toDate();
  });
};

Custom.title = function (date, _ref2) {
  var formats = _ref2.formats,
      culture = _ref2.culture,
      visibleDates = _ref2.visibleDates;

  if (visibleDates) {
    var start = visibleDates[0],
        rest = visibleDates.slice(1);
