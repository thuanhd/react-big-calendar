  ...
  var DragAndDropCalendar = function (_React$Component) {
    ...
    function DragAndDropCalendar() {
      ...
      _this.handleStateChange = function () {
        ...
        if (isDragging) {
          setTimeout(function () {
            var container = document.getElementsByClassName('rbc-calendar rbc-addons-dnd')[0];
          ...
          setTimeout(function () {
            ...
            if (container.className.indexOf("rbc-addons-dnd-is-dragging") >= 0) {
              var a = container.className.split(' ');
              a = a.filter(function (x) {
                return x.trim() !== "rbc-addons-dnd-is-dragging";
              });
    ...
    DragAndDropCalendar.prototype.render = function render() {
      ...
      props.className = (0, _classnames2.default)(props.className, 'rbc-addons-dnd'
