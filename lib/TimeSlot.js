...
var TimeSlot = function (_Component) {
  ...
  TimeSlot.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      Wrapper,
      { value: value, practitioner: practitioner, resource: resource },
      _react2.default.createElement(
        'div',
        {
          onClick: function onClick() {
            return _this2.handleSlotClick();
          },
          style: style,
  ...
  TimeSlot.prototype.handleSlotClick = function handleSlotClick() {
    var _props2 = this.props,
        value = _props2.value,
        practitioner = _props2.practitioner;

    var end = (0, _moment2.default)(value).add(this.props.step, 'minutes').toDate();
