...
var TimeColumn = function (_Component) {
  ...
  TimeColumn.prototype.renderTimeSliceGroup = function renderTimeSliceGroup(key, isNow, date, resource) {
    ...
    var isWorkingHour = !workingHourRange || workingHourRange && hour >= workingHourRange.from && hour <= workingHourRange.to;

    var practitionerAvaiable = true;
    var from = practitioner && practitioner.workingHours && practitioner.workingHours.from;
    var to = practitioner && practitioner.workingHours && practitioner.workingHours.to;
  ...
  TimeColumn.prototype.handleSelect = function handleSelect(slotInfo) {
