...
var DayColumn = function (_React$Component) {
  ...
  DayColumn.prototype.render = function render() {
    var _props = this.props,
        ...
        workingHourRange = _props.workingHourRange,
        group = _props.group,
        props = _objectWithoutProperties(_props, ['min', 'max', 'step', 'now', 'isOff', 'selectRangeFormat', 'culture', 'dayPropGetter', 'workingHourRange', 'group']);
    ...
    return _react2.default.createElement(
      ...
      _extends({}, props, {
        ...
        className: (0, _classnames2.default)('rbc-day-slot', className, this.props.className, isOff && 'rbc-off'),
        style: style,
        now: now,
        min: min,
        max: max,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderEvents = function () {
    ...
    return styledEvents.map(function (_ref2, idx) {
      ...
      if (_this2.props.showFormatter) {
        title = _this2.props.showFormatter(event);
      }

      var wrapText = _dates2.default.diff(event.start, event.end, 'minutes') > step * 2;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'hidden', className: 'step-height', value: height / _dates2.default.diff(event.start, event.end) }),
          _react2.default.createElement('input', { type: 'hidden', className: 'step-top', value: top }),
          _react2.default.createElement(
            'div',
            { className: 'rbc-event-content' },
            EventComponent ? _react2.default.createElement(EventComponent, { event: event, title: title, wrapText: wrapText }) : title
          ),
          _react2.default.createElement(
            'div',
